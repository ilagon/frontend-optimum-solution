...
export default function BodyContainer() {
  ...
  const handleSubmit = () => {
    axios
      .post(/*"https://bankapp-backend.herokuapp.com/payment_history/addPayment"*/"http://localhost:9000/payment_history/addPayment", {
      ...
      .then((response) => {
        ...
        axios
          .patch(/*"https://bankapp-backend.herokuapp.com/creditcard/updateBalance"*/"http://localhost:9000/creditcard/updateBalance", {
            creditcardId: state.mobilePayment.creditCard._id,
            creditcard_balance:
