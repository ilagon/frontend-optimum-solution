      ...
      .then((response) => {
        ...
        axios
          .patch("http://localhost:9000/creditcard/updateBalance", {
            creditcardId: states.senderCreditCardID,
            creditcard_balance:
              states.senderCreditCardBalance - states.transferAmount,
          })
          .then((response2) => {
          ...
          <div>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12} md={7} lg={6}>
                ...
                <p style={{ color: "#173a77", fontSize: "1.55em" }}>
                  {states.recipientName}
                </p>
                ...
                >
                  {states.recipentBank} Savings Account
                </p>
