...
export default function BodyContainer() {
  ...
  const formTo = (
    <div className="toForm">
      <h1>To</h1>
      <div>
        <TextField required className={classes.textBoxMargin} id="phoneNumberInput" label="Phone Number" />
      </div>
      <div>
        <TextField required className={classes.textBoxMargin} id="amountInput" label="Amount" />
      </div>
    </div>
  );
  ...
  const formFrom = (
    <div className="fromForm">
      ...
      <Select
        ...
        <Button id="nextButton" variant="contained">Next</Button>
    </div>
  );
